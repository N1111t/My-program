...
add_arg('configs',          str,    'configs/base.yml',   '配置文件')
add_arg('use_ms_model',     str,    None,                    '使用ModelScope上公开Emotion2vec的模型')
add_arg('use_gpu',          bool,   True,                    '是否使用GPU预测')
add_arg('audio_path',       str,    'inference/test.wav',      '音频路径')
add_arg('model_path',       str,    'models/Base_Emotion2Vec/best_model/',     '导出的预测模型文件路径')
